...
public class ProductDB implements ProductDBIF {
	...
	private static final String FIND_ALL_Q = "select productid, productname, skuno, productqty from product";
	...
	private static final String INSERT_Q = "insert into product (productid, productname, skuno, productqty) values (?, ?, ?, ?)";
	...
	public Product insert(Product product) throws DataAccessException {
		// productname, skuno, productqty, productid
		try {
